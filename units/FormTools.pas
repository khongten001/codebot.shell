...
uses
  ...
  BaseTypes, GraphTools, ProviderTools{$IFDEF GDIPLUS}, GdiPlus{$ENDIF};
...
{ TEmptyWindow }
  ...
  TEmptyWindow = class(TProviderCustomControl)
  protected
    procedure Paint; override;
  public
    constructor Create(AOwner: TComponent); override;
...
{ TCustomFramedWindow }
  ...
  TCustomFramedWindow = class(TProviderCustomControl)
  private
    FActive: Boolean;
...
begin
  ...
  begin
    ...
    begin
      E.Top := 1;
      E.Height := InternalHeight - 1;
    end
    else
    begin
      E.Top := 2;
      E.Height := InternalHeight - 2;
    end;
    E.TabStop := True;
    E.TabOrder := I;
  end;
...
initialization
{$IFDEF GDIPLUS}
  GraphicsFromCanvasImpl := GraphicsFromCanvasImplementation;
{$ENDIF}
  LoadQueryInterface;
end.
